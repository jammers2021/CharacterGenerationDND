...
namespace CharacterGenerationDND.DNDModelsAndServices.Models
{
    public class Character
    {
        ...
        public bool CrossbowExpertFeat { get; set; } = false;
		public bool ToughFeat { get; set; } = false;
		public bool SharpshooterFeat { get; set; } = false;
        public bool Actor { get; set; } = false;
        public bool GreatWeaponMaster { get; set; } = false;
		public bool PoleArmMaster { get; set; } = false;
		public bool KeenMind { get; set; } = false;
        public bool ObservantFeat { get; set; } = false;
        ...
        public bool ResilientCon { get; set; }
        public bool TelekineticFeat { get; set; }= false;
        public bool FeyTouchedFeat { get; set; } = false;
        public bool MobileFeat { get; set; } = false;
        public bool ChefFeat { get; set; } = false;
        public bool AlertFeat { get; set; } = false;
        ...
        public bool WarcasterFeat { get; set; } = false;
        public bool MetaMagicAdeptFeat1 { get; set; } = false;
		public bool MetaMagicAdeptFeat2 { get; set; } = false;
		public bool EldritchAdeptFeat1 { get; set; } = false;
		public bool EldritchAdeptFeat2 { get; set; } = false;
	}
}
